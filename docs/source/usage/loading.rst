...
To load pellets, select the tool and heat it up to the temperature needed for the material. Insert the pellets into the hopper on the side. Use the "prime pellet head" macro on the right side of the Duet web interface. After XX seconds slowly extrude 10mm at a time using the buttons on the Duet Web interface, until material is extruded through the nozzle.
